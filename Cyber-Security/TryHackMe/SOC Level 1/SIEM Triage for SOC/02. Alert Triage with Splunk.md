...
This is a clear indicator of persistence activity. At this point I would do some threat intelligence on the domain name on a platform like VirusTotal which may reveal some more information about the threat actor. In any case, this would be classified as a True Positive and escalated to L2 analyst
